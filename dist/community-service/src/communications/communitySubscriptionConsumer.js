...
exports.CommunityServiceConsumer = void 0;
const streamrx_common_1 = require("streamrx_common");
class CommunityServiceConsumer {
    constructor(userService, channelService, channelSubscriptionService) {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.rabbitMQConnection.connect(process.env.amqp_port || "amqp://localhost");
                ...
                yield this.rabbitMQConsumer.consumeFromExchange("subscription-created", this.handleSubscriptionCreatedMessage.bind(this));
    ...
    handleSubscriptionCreatedMessage(msg) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!msg)
                return;
            try {
                const message = JSON.parse(msg.content.toString());
                console.log("[INFO] User Updated message:", message);
                yield this.channelSubscriptionService.subscribe(message.userId, message.channelId);
            }
            catch (error) {
                console.error("[ERROR] Failed to handle user updated message:", error);
                throw error;
...
exports.CommunityServiceConsumer = CommunityServiceConsumer;
